    ...
    const double&                                   compactness)//weight given to spatial distance
{
	...
	//--------------------------------------------------
	GetLABXYSeeds_ForGivenStepSize(kseedsl, kseedsa, kseedsb, kseedsx, kseedsy, STEP);
	...
	for( int j = 0; j < height; j++ )
	{
		for( int k = 0; k < width; k++ )
		{
			if( 0 > nlabels[oindex] )
			{
				...
				//-------------------------------------------------------
				// Flooding algorithm: color all adjacent pixels with same label
				//-------------------------------------------------------
				int count(1);
	...
	const unsigned int&				color )
{
	...
	//-------------------------------------------------------
	// Paint contour_pixels white and pixels around contour_pixels black~
	//-------------------------------------------------------
...
void SLIC::Drawcolors_Forlabels(
		unsigned int*&				ubuff,
		int*&						labels,
		const int&					width,
		const int&					height,
	...
	for( int j = 0; j < height; j++ )
		{
			...
			{
				int ii = j*width + k;
				ubuff[ii] = color[labels[ii]] % 0xffffff;
			}
		}
}